...
transaction_type = st.selectbox("Transaction_type",["PAYMENT","TRANSFER","CASH_OUT","DEPOSIT"])
...
if st.button("Predict"):
    ...
    }])   # }] properly closes the dictionary
...
# run on terminal : streamlit run fraud_detection.py
